...
public:
	...
	Scene() :
		...
		shapeChoice("Model Shape:", "Sphere|Cube|Cylinder|Torus|Icosahedron|Teapot|Revolution|Praying Mantis", 7), //457 animator UI only allows shapes
		shaderChoice("Shader To Use:", "None|Default|Default with texture|Cartoon|Clouds|Bump mapping", 0),
	...
	ParticleSystem* getParticleSystem() override 
	{
		return prayingMantis.getParticleSystem();
	}
};
