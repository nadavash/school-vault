...
inline void FltDesignUI::cb_Apply_i(Fl_Button*, void*) {
  impUI->applyFilter();
}
void FltDesignUI::cb_Apply(Fl_Button* o, void* v) {
  ((FltDesignUI*)(o->parent()->user_data()))->cb_Apply_i(o,v);
}
...
inline void FltDesignUI::cb_Normalize_i(Fl_Button*, void*) {
	double sum = 0;
	for (int i = 0; i < 24; i++) {
		sum += ((Fl_Value_Input*)kernel->child(i))->value();
	}
	scale->value(sum);
}
void FltDesignUI::cb_Normalize(Fl_Button* o, void* v) {
	((FltDesignUI*)(o->parent()->user_data()))->cb_Normalize_i(o, v);
}

FltDesignUI::FltDesignUI() {
  Fl_Window* w;
  { Fl_Window* o = mainWindow = new Fl_Window(286, 340, "Filter Design UI");
    w = o;
    ...
    { Fl_Button* o = new Fl_Button(152, 300, 124, 24, "Cancel");
      o->callback((Fl_Callback*)cb_Cancel);
    }
    { Fl_Button* o = new Fl_Button(8, 300, 128, 24, "Apply");
      o->callback((Fl_Callback*)cb_Apply);
    }
    { Fl_Button* o = new Fl_Button(8, 264, 268, 24, "Preview");
      o->callback((Fl_Callback*)cb_Preview);
    }
	{ Fl_Button* o = new Fl_Button(8, 228, 268, 24, "Normalize");
