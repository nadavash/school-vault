...
public:
	...
	void setNormalMap(TextureMap* normal) { _normalMap = normal; }
	bool hasNormalMap() { return _normalMap != nullptr; }
	Vec3d getNormalAt(const Vec2d& uv) { return _normalMap ? _normalMap->getMappedValue(uv) - Vec3d(0.5,0.5,05) : Vec3d(); }
