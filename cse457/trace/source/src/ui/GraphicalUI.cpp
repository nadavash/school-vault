...
void GraphicalUI::cb_antialiasEnabledCheckButton(Fl_Widget* o, void* v)
{
	GraphicalUI* pUI = (GraphicalUI*)(o->user_data());
	pUI->m_antialias_enabled_value = (((Fl_Check_Button*)o)->value() == 1);
}

void GraphicalUI::cb_terminationEnabledCheckButton(Fl_Widget* o, void* v)
{
	GraphicalUI* pUI = (GraphicalUI*)(o->user_data());
	pUI->m_termination_enabled_value = (((Fl_Check_Button*)o)->value() == 1);
}

void GraphicalUI::cb_terminationSlides(Fl_Widget* o, void* v)
{
	((GraphicalUI*)(o->user_data()))->m_nTermination = double(((Fl_Slider *)o)->value());
	//((GraphicalUI*)(o->user_data()))->m_nDepth = int(((Fl_Slider *)o)->value());
}
...
GraphicalUI::GraphicalUI() : m_nativeChooser(NULL) {
	...
	m_mainWindow = new Fl_Window(100, 40, 350, 310, "Ray <Not Loaded>");
		...
		// set up regular antialiasing checkbox
		m_antialias_enabledCheckButton = new Fl_Check_Button(0, 230, 180, 20, "Antialias Enabled");
		m_antialias_enabledCheckButton->user_data((void*)(this));
		m_antialias_enabledCheckButton->callback(cb_antialiasEnabledCheckButton);
		m_antialias_enabledCheckButton->value(m_antialias_enabled_value);

		// set up termination checkbox
		m_termination_enabledCheckButton = new Fl_Check_Button(0, 205, 180, 20, "Adaptive Termination Enabled");
		m_termination_enabledCheckButton->user_data((void*)(this));
		m_termination_enabledCheckButton->callback(cb_terminationEnabledCheckButton);
		m_termination_enabledCheckButton->value(m_termination_enabled_value);

		// install termination slider
		m_terminationSlider = new Fl_Value_Slider(10, 105, 180, 20, "Adaptive Termination");
		m_terminationSlider->user_data((void*)(this));	// record self to be used by static callback functions
		m_terminationSlider->type(FL_HOR_NICE_SLIDER);
		m_terminationSlider->labelfont(FL_COURIER);
		m_terminationSlider->labelsize(12);
		m_terminationSlider->minimum(0.0);
		m_terminationSlider->maximum(10.0);
		m_terminationSlider->step(0.1);
		m_terminationSlider->value(m_nTermination);
		m_terminationSlider->align(FL_ALIGN_RIGHT);
		m_terminationSlider->callback(cb_terminationSlides);
