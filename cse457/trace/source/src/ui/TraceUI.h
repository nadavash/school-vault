...
public:
	TraceUI()
		...
		m_antialias_enabled_value( false ),
		m_nTermination( 0.00 ),
		m_termination_enabled_value( false ),
		raytracer( 0 )
	{ }
...
public:
	...
	bool		getAntialiasEnabled() const { return m_antialias_enabled_value; }
	double		getTermination() const { return m_nTermination; }
	bool		getTerminationEnabled() const { return m_termination_enabled_value; }


protected:
	bool		m_bsp_enabled_value;
	bool		m_antialias_enabled_value;
	bool		m_termination_enabled_value;
	double		m_nTermination;
