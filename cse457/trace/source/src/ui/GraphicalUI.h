...
public:
	...
	Fl_Check_Button*	m_antialias_enabledCheckButton;
	Fl_Check_Button*	m_termination_enabledCheckButton;
	Fl_Check_Button*	m_bsp_enabledCheckButton;
	Fl_Check_Button*	m_debuggingDisplayCheckButton;
	Fl_Slider*			m_terminationSlider;
...
// static class members
	...
	static void cb_antialiasEnabledCheckButton(Fl_Widget* o, void* v);
	static void cb_terminationEnabledCheckButton(Fl_Widget* o, void* v);
	static void cb_bspEnabledCheckButton(Fl_Widget* o, void* v);
	static void cb_debuggingDisplayCheckButton(Fl_Widget* o, void* v);
	static void cb_terminationSlides(Fl_Widget* o, void* v);
