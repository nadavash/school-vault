...
public class Reverb {
	...
	public static void main(String[] args) {
		...
		if (args.length != 3) {
            ...
            System.err
                    .println("\tjava Reverb <delay millis> <input file> <output file>");
        ...
        if (delay == 0)
            ...
            System.err.println("\tSaw " + args[0]
                    + " instead of integer as first argument");
            System.exit(1);
        }
	...
	public static void addReverb(int millis, List<Double> samples) {
