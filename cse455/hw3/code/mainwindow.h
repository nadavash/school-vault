...
private:
    ...
    void SSD(QImage image1, QImage image2, int minDisparity, int maxDisparity, int offset, double *matchCost);
    void SAD(QImage image1, QImage image2, int minDisparity, int maxDisparity, int offset, double *matchCost);
    void NCC(QImage image1, QImage image2, int minDisparity, int maxDisparity, int offset, double *matchCost);
